...
"""RNN POS Tagging many-to-many multi-class classification neural network model structure definition"""
...
class RNNPOSTagger(nn.Module):
    ...
    def forward(self, sample):
        ...
        #(4) Activation function: defines the output range. Eg. Tanh: (-1,+1); ReLU: (-inf,+inf)
